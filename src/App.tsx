...
import { tempCleric, tempRanger, tempWarrior, tempWizard } from "./types/Character";
    ...
    <Router>
      <div className="flex flex-col h-screen bg-gray-900 text-white">
        ...
        <Routes>
          ...
          <Route path={"/party"} element={<PartySelection availableCharacters={[tempRanger, tempWarrior, tempCleric, tempWizard]} />} />
