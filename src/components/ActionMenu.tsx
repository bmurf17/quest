...
function ActionBtn({
  ...
  const colors = {
    default: {
      ...
      hover: "rgba(180,140,80,0.12)",
      border: themeColors.goldBorder,
      text: themeColors.goldMuted,
    },
    danger: {
    ...
    muted: {
      ...
      border: themeColors.subtleBorder,
      text: "#4B5563",
    },
  };
    ...
    <div
      ...
      onMouseLeave={(e) => {
        ...
        e.currentTarget.style.borderColor = disabled
          ? themeColors.subtleBorder
          : themeColors.goldBorder;
...
export default function ActionMenu() {
    ...
    if (spell.effect.type === "damage") {
      if (spell.effect.target === "single") {
        room.enemies.length === 1
          ...
          : (setTargeting(true), setTargetingSpell(spell));
  ...
  const npc =
    room?.interaction?.type === "NPC"
      ? (room.interaction as { type: "NPC"; npc: NPC }).npc
      : null;
  const chest =
    room?.interaction?.type === "chest"
      ? (room.interaction.chest as Chest)
      : null;
  const camp =
      ...
      >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            !partyHasAnimalHandling(party) ? (
              ...
              <ActionBtn onClick={() => speak(npc)} fullWidth>
                ...
                {useGameStore.getState().dialogueIndex < npc.dialogue.length - 1
                  ? "Continue Dialogue"
                  : "Speak"}
              </ActionBtn>
            )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            {!chest.isOpen ? (
              ...
              >
                ...
                <ActionBtn
                  variant="success"
                  onClick={() => takeFromChest({ ...chest, quantity: 0 })}
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
        ...
        {camp && (
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <ActionBtn variant="success" onClick={() => rest(camp)} fullWidth>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
        ...
        {gameStatus === GameStatus.InTown && (
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <ActionBtn variant="success" onClick={() => restInTown()} fullWidth>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
          ...
          <ActionBtn onClick={() => setIsInventoryModalOpen(true)} fullWidth>
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M20.25 7.5l-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5m8.25 3v6.75m0 0-3-3m3 3 3-3M3.75 7.5h16.5M8.625 4.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"
              />
            </svg>
            Inventory
          </ActionBtn>
