  ...
  .settings-link {
      ...
      <div
        style={{
          minHeight: "100vh",
          background:
            "linear-gradient(160deg, #0d0b07 0%, #1a1209 55%, #0f0e09 100%)",
          display: "flex",
      ...
      >
        <div
          style={{
            ...
            pointerEvents: "none",
            backgroundImage:
              "radial-gradient(circle, rgba(180,140,80,0.1) 1px, transparent 1px)",
        ...
        <div
          style={{
            ...
            pointerEvents: "none",
            background:
              "radial-gradient(ellipse at center, transparent 30%, rgba(13,11,7,0.85) 100%)",
          }}
        />
          ...
          >
            <div
              style={{
                ...
                height: 1,
                background:
                  "linear-gradient(to left, rgba(180,140,80,0.3), transparent)",
              }}
            />
              ...
              {[0, 1, 2].map((i) => (
                <div
                  ...
                  style={{
                    width: 3,
                    height: 3,
                    background: `rgba(212,175,55,${0.2 + i * 0.15})`,
                    borderRadius: "50%",
                  }}
                />
              ))}
            ...
            <div
              style={{
                ...
                height: 1,
                background:
                  "linear-gradient(to right, rgba(180,140,80,0.3), transparent)",
              }}
            />
          </div>

          <div className="home-btn">
            <Link to="/party" className="start-btn">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
