...
const navSections = [
  {
    ...
    items: [
      ...
      {
        label: "Sections",
        description: "Manage exploration sections and ordering",
        to: "/admin/game-design/sections",
        icon: (
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} width={22} height={22}>
      ...
      {
        label: "Dialogues",
        description: "Create dialogue trees with branching choices",
        to: "/admin/game-design/dialogues",
        icon: (
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} width={22} height={22}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M8.625 12c0-.165.047-.323.136-.485a1.5 1.5 0 1 1 2.178 2.178c-.162.089-.32.136-.485.136-.165 0-.323-.047-.485-.136a1.5 1.5 0 0 1-2.178-2.178c.162-.089.32-.136.485-.136ZM12 12c0-.165.047-.323.136-.485a1.5 1.5 0 1 1 2.178 2.178c-.162.089-.32.136-.485.136-.165 0-.323-.047-.485-.136a1.5 1.5 0 0 1-2.178-2.178c.162-.089.32-.136.485-.136ZM12 12c0-.165.047-.323.136-.485a1.5 1.5 0 1 1 2.178 2.178c-.162.089-.32.136-.485.136-.165 0-.323-.047-.485-.136a1.5 1.5 0 0 1-2.178-2.178c.162-.089.32-.136.485-.136Z" />
          </svg>
        ),
        accent: "#10B981",
